...
export default function UserGroupManagement() {
  ...
  const handleEdit = (group: UserGroup) => {
    ...
    form.reset({
      ...
      permissions: {
        staff: group.permissions.staff || "NONE",
        departments: group.permissions.departments || "NONE",
        rooms: group.permissions.rooms || "NONE",
        categories: group.permissions.categories || "NONE",
        workSchedules: group.permissions.workSchedules || "NONE",
        meetingSchedules: group.permissions.meetingSchedules || "NONE",
        otherEvents: group.permissions.otherEvents || "NONE",
        permissions: group.permissions.permissions || "NONE",
        systemConfig: group.permissions.systemConfig || "NONE",
        users: group.permissions.users || "NONE",
        holidays: group.permissions.holidays || "NONE",
      },
    });
    setShowModal(true);
  };

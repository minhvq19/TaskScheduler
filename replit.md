...
- **August 8, 2025**: Thiết kế lại màn hình công cộng phần lịch phòng họp theo mẫu bảng chuyên nghiệp. Bảng hiển thị 5 cột: Thứ tự, Thời gian, Địa điểm, Nội dung cuộc họp, Đầu mối. Sắp xếp theo thời gian bắt đầu gần nhất, hiển thị tối đa 20 lịch với font Roboto dễ đọc. Header màu cam, hàng dữ liệu màu teal theo thiết kế BIDV.
